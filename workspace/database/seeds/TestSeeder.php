...
class TestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $members = [
            ['83b5603f-8436-4c93-189e-8387c15f823f', '橋本環奈', 'はしもとかんな', '代表取締役社長', 'hashikann@hashikann.com', 'EgGvxAr4Wm97jGg1VNitMGj5JFovqhTZEDSIssnmkiFF6Sp0anJ5v07nLeHQ', '$2y$10$MPEgFZgwoRLZ3idAD4Oo9uSO2kGWl33o4QOvVIPU5Cu8z2TXQBMvS'/* 19990203 */, '080-1234-5678', ['name' => '小泉純一郎', 'mail' => 'koizumi@hashikann.com'], [], '東京笑門会', true, '1h', false, []]
        ];

        // _id, name, address, telephone_number, members
        $companies = [
            ['e6a91e70-bae6-08e0-8ee7-0a7f595f30fc', '株式会社橋環', '東京都hoge区', '0120-123-456', ['83b5603f-8436-4c93-189e-8387c15f823f']]
        ];
